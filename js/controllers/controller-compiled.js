...
angular.module('myApp').controller("homeController", ['$scope', 'LocalDataService', function ($scope, localData) {
...
}]).controller("optionsController", ['$scope', '$routeParams', function ($scope, $routeParams) {
...
}]).controller("playerController", ["$scope", '$routeParams', function ($scope, $routeParams) {
...
}]).controller("compicsController", ["$scope", function ($scope) {
